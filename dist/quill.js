      ...
      this.quill.root.addEventListener('keydown', function (evt) {
        ...
        if (prevKeyEvent.keyCode === 8 && !(evt.keyCode < 193)) {
          ...
          if (now - prevKeyEvent.time < 50) {
            ...
            try {
              for (var _iterator = Object.keys(prevKeyEvent.formats)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                var key = _step.value;

                _this2.quill.format(key, prevKeyEvent.formats[key]);
              }
            } catch (err) {
        ...
        if (evt.keyCode === 8) {
          ...
          prevKeyEvent.formats = _this2.quill.getFormat();
        }
